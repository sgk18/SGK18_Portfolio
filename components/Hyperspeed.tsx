...
class CarLights {
  ...
  init() {
    ...
    if (Array.isArray(this.colors)) colorArray = this.colors.map(c => new THREE.Color(c));
    else colorArray = [new THREE.Color(this.colors)];
...
class LightsSticks {
  ...
  init() {
    ...
    let colorArray: THREE.Color[];
    if (Array.isArray(options.colors.sticks)) colorArray = (options.colors.sticks as any[]).map(c => new THREE.Color(c));
    else colorArray = [new THREE.Color(options.colors.sticks)];
